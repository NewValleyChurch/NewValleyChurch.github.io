...
There are multiple audio tracks in this set.  Each track corresponds to a Fader Strip on the QU-32, with one exception:  the [DMXIS](/DMXIS.html) track is a _MIDI_ track, and it controls every aspect of the lighting automation.  

The QU-32 has Custom Layer mappings (Fader 1-3) which control the [DMXIS](/DMXIS.html) Plug-in which sits in the [DMXIS](/DMXIS.html) MIDI Track.  (If you wish to see the devices that are dropped into the track, Double click the [DMXIS](/DMXIS.html) track title.)
...
- **[DMXIS](/DMXIS.html):**  This is the MIDI track that contains the [DMXIS](/DMXIS.html) lighting controller plug-in.
